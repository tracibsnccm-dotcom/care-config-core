...
BEGIN
  ...
  DROP POLICY IF EXISTS "Clients can insert own preferences" ON public.client_preferences;
  DROP POLICY IF EXISTS "Clients can update own preferences" ON public.client_preferences;
  DROP POLICY IF EXISTS "Staff can view preferences" ON public.client_preferences;
  DROP POLICY IF EXISTS "Users can view alerts for their cases" ON public.case_alerts;
  DROP POLICY IF EXISTS "RN and staff can create alerts" ON public.case_alerts;
  DROP POLICY IF EXISTS "Staff can update alerts" ON public.case_alerts;
  DROP POLICY IF EXISTS "Authorized staff can view disclosure logs" ON public.disclosure_log;
  DROP POLICY IF EXISTS "RN and staff can create disclosure logs" ON public.disclosure_log;
EXCEPTION
...
DROP TRIGGER IF EXISTS client_preferences_updated_at ON public.client_preferences;
