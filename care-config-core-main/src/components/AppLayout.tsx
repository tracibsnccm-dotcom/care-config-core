...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  // Hide navigation in demo mode - demo uses DemoHub instead
  ...
  // In demo mode, hide all navigation items (demo uses DemoHub, not AppLayout navigation)
  const filteredNav = inDemoMode ? [] : navigation.filter((item) => canAccessRoute(item.roles));
