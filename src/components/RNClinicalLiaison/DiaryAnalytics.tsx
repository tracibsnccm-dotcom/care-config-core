...
export function DiaryAnalytics({ entries }: DiaryAnalyticsProps) {
  ...
  function calculateAnalytics() {
    ...
    const recentEntries = entries.filter((e: any) => 
      new Date(e.scheduled_date) >= thirtyDaysAgo
    );

    // Calculate completion stats
    const total = recentEntries.length;
    const completed = recentEntries.filter((e: any) => e.completion_status === "completed").length;
    const overdue = recentEntries.filter((e: any) => e.completion_status === "overdue").length;
    
    // Calculate on-time completions
    const onTime = recentEntries.filter((e: any) => {
