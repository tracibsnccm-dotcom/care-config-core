  ...
  return (
    <section id="rcms-tiers" aria-labelledby="rcms-tiers-title" className={`rcms-tiers tier-${currentTier?.toLowerCase() || ''}`}>
      <style>{`
        ...
        .rcms-tiers.tier-basic .rcms-table th:nth-child(2), .rcms-tiers.tier-basic .rcms-table td:nth-child(2), .rcms-tiers.tier-clinical .rcms-table th:nth-child(3), .rcms-tiers.tier-clinical .rcms-table td:nth-child(3), .rcms-tiers.tier-premium .rcms-table th:nth-child(4), .rcms-tiers.tier-premium .rcms-table td:nth-child(4) { position: relative; background: #fff; z-index: 1; box-shadow: 0 8px 18px rgba(0,0,0,0.08), 0 0 0 2px rgba(176,152,55,0.35); transform: translateZ(0) scale(1.01); transition: box-shadow 160ms ease, transform 160ms ease; }
        ...
        .rcms-tiers.tier-basic .rcms-table td:nth-child(2):hover, .rcms-tiers.tier-clinical .rcms-table td:nth-child(3):hover, .rcms-tiers.tier-premium .rcms-table td:nth-child(4):hover, .rcms-tiers.tier-basic .rcms-table th:nth-child(2):focus-within, .rcms-tiers.tier-clinical .rcms-table th:nth-child(3):focus-within, .rcms-tiers.tier-premium .rcms-table th:nth-child(4):focus-within { box-shadow: 0 10px 22px rgba(0,0,0,0.10), 0 0 0 2px rgba(176,152,55,0.45); transform: translateZ(0) scale(1.012); }
        @media (prefers-reduced-motion: reduce) { .rcms-tiers.tier-basic .rcms-table th:nth-child(2), .rcms-tiers.tier-basic .rcms-table td:nth-child(2), .rcms-tiers.tier-clinical .rcms-table th:nth-child(3), .rcms-tiers.tier-clinical .rcms-table td:nth-child(3), .rcms-tiers.tier-premium .rcms-table th:nth-child(4), .rcms-tiers.tier-premium .rcms-table td:nth-child(4) { transform: none; transition: box-shadow 160ms ease; } }
