      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                { task: "Schedule provider consultation", priority: "High" },
                { task: "Follow up on insurance authorization", priority: "Medium" },
                { task: "Coordinate document delivery", priority: "Low" },
              ].map((task, idx) => (
