...
export type Role = "CLIENT" | "ATTORNEY" | "RN_CCM" | "STAFF" | "SUPER_USER" | "SUPER_ADMIN";

const EXPORT_ALLOWED: Role[] = ["RN_CCM", "SUPER_USER", "SUPER_ADMIN"]; // keep attorneys out for clinical CSVs
